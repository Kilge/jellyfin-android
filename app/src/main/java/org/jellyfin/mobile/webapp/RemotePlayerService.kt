        ...
        override fun onReceive(context: Context, intent: Intent) {
            when (intent.action) {
                AudioManager.ACTION_HEADSET_PLUG -> {
                    ...
                    if (state == 0) webappFunctionChannel.playbackCommand(PLAYBACK_MANAGER_COMMAND_PAUSE)
                }
                ...
                BluetoothA2dp.ACTION_CONNECTION_STATE_CHANGED -> {
                    ...
                    if ((state == BluetoothA2dp.STATE_DISCONNECTED || state == BluetoothA2dp.STATE_DISCONNECTING) && previousState == BluetoothA2dp.STATE_CONNECTED) {
                        webappFunctionChannel.playbackCommand(PLAYBACK_MANAGER_COMMAND_PAUSE)
                    }
                }
        ...
        mediaSession = MediaSession(applicationContext, javaClass.toString()).apply {
            ...
            setCallback(
                ...
                object : MediaSession.Callback() {
                    override fun onPlay() {
                        webappFunctionChannel.playbackCommand(PLAYBACK_MANAGER_COMMAND_PLAY)
                    }
                    ...
                    override fun onSkipToPrevious() {
                        webappFunctionChannel.playbackCommand(PLAYBACK_MANAGER_COMMAND_PREVIOUS)
                    }

                    override fun onSkipToNext() {
                        webappFunctionChannel.playbackCommand(PLAYBACK_MANAGER_COMMAND_NEXT)
                    }

                    override fun onRewind() {
                        webappFunctionChannel.playbackCommand(PLAYBACK_MANAGER_COMMAND_REWIND)
                    }

                    override fun onFastForward() {
                        webappFunctionChannel.playbackCommand(PLAYBACK_MANAGER_COMMAND_FAST_FORWARD)
                    }

                    override fun onStop() {
                        webappFunctionChannel.playbackCommand(PLAYBACK_MANAGER_COMMAND_STOP)
                        onStopped()
                    }
