...
object Constants {
    ...
    const val PREF_SYSTEM_DARK_THEME = "pref_system_dark_theme"
    ...
    // Web player media session constants
    const val SUPPORTED_WEB_PLAYER_PLAYBACK_ACTIONS: Long = PlaybackState.ACTION_PLAY_PAUSE or
        PlaybackState.ACTION_PLAY or
        PlaybackState.ACTION_PAUSE or
        PlaybackState.ACTION_STOP or
        PlaybackState.ACTION_SKIP_TO_NEXT or
