...
class SettingsFragment : Fragment(), BackPressInterceptor {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        // Back arrow with the 87% black/white icon color (matches the web
        // skinHeader); the system default arrow uses colorControlNormal.
        binding.toolbar.setNavigationIcon(R.drawable.ic_arrow_back)
        binding.toolbar.setNavigationContentDescription(getString(R.string.action_back))
